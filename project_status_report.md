...
- fix the database seeder, some of the orders are already past May 2026... 
- improve orders-overview KPI design
- fix the sidebar buttons (shouldn't act as checkbox)
- the data on the admin panel (products sold) does not match the one displayed on the home page

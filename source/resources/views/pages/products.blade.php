            ...
            <form action="/products" method="GET" class="p-6">
                ...
                <div class="mb-6" x-data="{
                    ...
                    <div x-show="open" x-collapse class="mt-2 space-y-2 px-3">
                        ...
                        <p x-show="filteredCategories.length === 0" class="text-xs text-gray-500 py-1">No categories found.
                        </p>
                    </div>
                </div>
                ...
                <section class="mb-12" x-data="productCarousel()">
                    <div class="mb-6 flex items-center justify-between">
                        ...
                        <div class="flex gap-2">
                            <button @click="scrollCarousel('carousel-{{ $group['category']->category_id }}', -400)"
                                type="button"
                                class="rounded-lg border border-gray-200 p-2 text-gray-600 transition-colors hover:bg-gray-100">
                    ...
                    <div id="carousel-{{ $group['category']->category_id }}"
                        ...
                        @foreach ($group['items'] as $product)
                            <div
                                ...
                                <div
                                    class="relative aspect-square bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <h3 class="mt-2 text-base font-bold text-gray-900 truncate"
                                        title="{{ $product->name }}">
                                        {{ $product->name }}
                                    </h3>

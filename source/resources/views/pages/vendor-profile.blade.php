                    ...
                    <div class="lg:col-span-1">
                        <div class="rounded-3xl border border-gray-100 bg-gradient-to-br from-white to-gray-50 p-8 shadow-lg transition-all duration-300 hover:shadow-xl">
                            <div class="flex flex-col items-center text-center">
                                ...
                                <h2 class="mt-8 text-xl font-bold text-gray-900">LCC Store</h2>
                                <p class="mt-1 text-sm text-green-600 font-semibold">Premium Member</p>
                                <p class="mt-2 text-gray-600">lcc@example.com</p>
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        <div class="flex-1 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-gray-600 cursor-not-allowed">LCC Store</div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        <div class="flex-1 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-gray-600 cursor-not-allowed">lcc@example.com</div>
                                ...
                                <div>
                                 ...
                                 <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Website Link</label>
                                    <div class="flex items-center gap-2">
                                        <div class="flex-1 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-gray-600 cursor-not-allowed">https://lccstore.com</div>

...
<div class="mx-auto max-w-7xl px-8 py-12">
    <div class="text-center">
        <h1 class="text-4xl font-bold tracking-tight text-zinc-900">Edit Product</h1>
        <p class="mt-2 text-zinc-500 text-sm">Fill in the details for the changes you want to add.</p>
    </div>
               ...
               {{-- Main Content --}}
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="rounded-3xl border border-gray-100 bg-gradient-to-br from-white to-gray-50 p-8 shadow-lg transition-all duration-300 hover:shadow-xl">
                            ...
                            <div class="space-y-5">
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Change Product Name</label>
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Change Product Description</label>
                                    <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Change Price</label>
                                    <div class="flex items-center gap-2">
                                        <div class="flex-1 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-gray-600 cursor-not-allowed">Enter Product Description</div>
                                      </div>
                                </div>
                                ...
                                <button type="button" class="px-10 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700">Change Product</button>
                            </div>
                        </div>
@endsection
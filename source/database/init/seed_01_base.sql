...
INSERT INTO addresses (user_id, street, city, province_state, postal_code, phone, email, country, created_at, updated_at) VALUES
...
INSERT INTO vendors (vendor_id, name, email, phone, website, address_id, active, cover_img, profile_img, created_at, updated_at) VALUES
...
INSERT INTO customers (customer_id, first_name, last_name, phone, birthdate, gender, profile_img, primary_address_id, created_at, updated_at) VALUES
...
INSERT INTO categories (category_id, name, is_active, slug, description, parent_id, created_at, updated_at) VALUES
...
-- Sub-categories
INSERT INTO categories (name, is_active, slug, description, parent_id, created_at, updated_at) VALUES
